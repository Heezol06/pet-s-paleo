...
const CatFood = () => {
  ...
  const CatFoods = foods.filter((food) => food.type.includes("Cat Food") )

  return (
    <div className=" mx-auto">
      <h1 className="text-4xl my-10 p-4 bg-green-300 inline-block rounded-xl">Cat Food</h1>
        ...
        {CatFoods.map((catFood) => (
          <div className="">
            <div
              ...
              bis_skin_checked="1"
            >
              <img class="p-8 rounded-t-lg" src={catFood.img} alt="product" />

              <div class="px-5 pb-5" bis_skin_checked="1">
                <h5 class="text-xl font-semibold tracking-tight text-start">
                  {catFood.name.slice(0,30)}...
                </h5>

                <div className="flex items-center justify-between">
                
                  <span class="text-xl font-bold text-gray-900 mt-2.5 mb-5">
                    Weight: <span className="text-orange-600">{catFood.weight}</span>
                  </span>
                  <span class="text-xl font-bold text-gray-900 mt-2.5 mb-5">
                    Price: <span className="text-orange-600">{catFood.price}</span>
                  </span>
                </div>
                <div
