      ...
      <div>
        <div class="p-4">
          ...
          <p class="text-center mb-32 text-xl font-normal text-gray-500">
            Meat the best Pet's Doctor in town.
          </p>
          <div className="lg:flex justify-center my-28">
            <div class="lg:flex items-center space-y-24 md:space-y-0 flex-col md:flex-row justify evenly">
              <div class="p-4 relative my-20 lg:my-1">
                ...
                <div class="bg-white rounded-lg shadow px-8 py-4 pt-24">
                  <div class="text-center">
                    <p class="text-2xl text-gray-800 ">Lloyd Wilson</p>
                    ...
                    <button className="btn glass text-black btn-wide mb-5 mt-1 bg-green-400">BOOK NOW</button>
                  </div>
              ...
              <div class="p-4 relative my-20 lg:my-1">
                ...
                <div class="bg-white rounded-lg shadow px-8 py-4 pt-24 ">
                  <div class="text-center">
                    <p class="text-2xl text-gray-800 ">Rachel Parker</p>
                    <p class="text-3xl text-green-500 font-light">
                      Life & Business Coach
                    </p>
                    <p class="text-md text-gray-500 w-60 dark:text-gray-400 mx-auto py-4 font-light">
              ...
              <div class="p-4 relative my-20 lg:my-1">
                ...
                <div class="bg-white rounded-lg shadow px-8 py-4 pt-24">
                  <div class="text-center">
                    <p class="text-2xl text-gray-800 ">Ian Smith</p>
                    <p class="text-3xl text-green-500 font-light">
                      Executive Coach
                    </p>
                    <p class="text-md text-gray-500 w-60 dark:text-gray-400 mx-auto py-4 font-light">
              ...
              <div class="p-4 relative my-20 lg:my-1">
                ...
                <div class="bg-white rounded-lg shadow px-8 py-4 pt-24">
                  <div class="text-center">
                    <p class="text-2xl text-gray-800 ">Alicia Henderson</p>
                    <p class="text-3xl text-green-500 font-light">
                      Health Coach
                    </p>
                    <p class="text-md text-gray-500 w-60 dark:text-gray-400 mx-auto py-4 font-light">
          ...
          <div className="lg:flex justify-center">
            <div class="lg:flex items-center space-y-24 md:space-y-0 flex-col md:flex-row justify evenly">
              <div class="p-4 relative my-20 lg:my-1">
                ...
                <div class="bg-white rounded-lg shadow px-8 py-4 pt-24">
                  <div class="text-center">
                    <p class="text-2xl text-gray-800 ">Rahman Khan</p>
                    <p class="text-3xl text-green-500 font-light">
                      Health Coach
                    </p>
                    <p class="text-md text-gray-500 w-60 dark:text-gray-400 mx-auto py-4 font-light">
              ...
              <div class="p-4 relative my-20 lg:my-1">
                ...
                <div class="bg-white rounded-lg shadow px-8 py-4 pt-24 ">
                  <div class="text-center">
                    <p class="text-2xl text-gray-800 ">Rakul Pretty</p>
                    <p class="text-3xl text-green-500 font-light">
                      Life & Business Coach
                    </p>
                    <p class="text-md text-gray-500 w-60 dark:text-gray-400 mx-auto py-4 font-light">
              ...
              <div class="p-4 relative my-20 lg:my-1">
                ...
                <div class="bg-white rounded-lg shadow px-8 py-4 pt-24">
                  <div class="text-center">
                    <p class="text-2xl text-gray-800 ">Stocks</p>
                    <p class="text-3xl text-green-500 font-light">
                      Executive Coach
                    </p>
                    <p class="text-md text-gray-500 w-60 dark:text-gray-400 mx-auto py-4 font-light">
              ...
              <div class="p-4 relative my-20 lg:my-1">
                ...
                <div class="bg-white rounded-lg shadow px-8 py-4 pt-24">
                  <div class="text-center">
                    <p class="text-2xl text-gray-800 ">Fred Henderson</p>
                    <p class="text-3xl text-green-500 font-light">
                      Health Coach
                    </p>
                    <p class="text-md text-gray-500 w-60 dark:text-gray-400 mx-auto py-4 font-light">
